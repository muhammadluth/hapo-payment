package com.pulsa.transaksi.atribut;
...
public class customListAdapter extends BaseAdapter implements Filterable {
    ...
    public customListAdapter(Activity tagihanListrik, ArrayList objects, Resources resLocal) {
        /********** Take passed values **********/
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_produk_1, null);
        ...
        TextView nominalProduk = convertView.findViewById(R.id.nominal);

        namaProduk.setText(produk.getJudul());
        harga.setText(NumberFormat.setNumberformat(produk.getHarga()));
        kodeProduk.setText(produk.getKodeProduk());
        nominalProduk.setText(produk.getNominal());
