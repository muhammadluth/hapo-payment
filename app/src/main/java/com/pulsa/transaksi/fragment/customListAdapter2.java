...
public class customListAdapter2 extends BaseAdapter implements Filterable {
    ...
    public customListAdapter2(Activity tagihanListrik, ArrayList objects, Resources resLocal) {
        /********** Take passed values **********/
